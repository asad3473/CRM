    ...
    return (
      <div className=''>
        ...
        <div className={`
          ...
          shadow-xl
        `}>
          <h1 className="font-bold text-xl hover:bg-white hover:text-black px-6 py-5 border-b border-gray-700 flex items-center">
            HQ Dashboard
          </h1>
          ...
          <div className="py-3 overflow-y-auto h-[calc(100vh-80px)]">
            ...
            <div className="absolute bottom-0 left-0 right-0 border-t border-gray-700 p-4 ">
              <Link
                to="/settings"
                className={`flex items-center gap-3 px-4 py-3 rounded-lg transition-all duration-200
                  ${location.pathname === '/settings' ? 'bg-white text-black' : 'hover:bg-white hover:text-black'}`}
              >

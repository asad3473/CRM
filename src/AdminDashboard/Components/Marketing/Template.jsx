      ...
      setTemplates([
        {
          ...
          content:
            "Remind customers about timely oil changes to extend vehicle life and performance.",
        },
        {
          id: "2",
          title: "Maintenance Reminder",
          content:
            "Notify users when their scheduled maintenance is due to avoid breakdowns.",
        },
        {
          id: "3",
          title: "Seasonal Checkup",
          content:
            "Encourage customers to get seasonal inspections (AC, heating, tires, fluids).",
        },
        {
          id: "4",
          title: "Customer Feedback Request",
          content:
            "Ask customers to rate their service experience and provide improvement suggestions.",
        },
        {
          id: "5",
          title: "Promotion / Discount Offer",
          content:
            "Send a promotional message with discounts on services to attract more visits.",
        },
        {
          id: "6",
          title: "Appointment Reminder",
          content:
            "Remind customers of their upcoming booking to reduce no-shows and delays.",
        },
      ]);
    }, 500);
    ...
    <div className="p-6 space-y-6">
      ...
      >
        ...
        <button
          ...
          className="px-5 py-2.5 rounded-xl bg-[#1c0b7e] text-white font-semibold shadow-lg hover:scale-105 hover:shadow-xl transition"
        >
          + New Template
        </button>
      </motion.div>

...
export default function AudiencesTagsPage() {
  ...
  useEffect(() => {
    setTimeout(() => {
      setAudiences([
        { id: "1", name: "VIP Customers", description: "High-value loyal customers" },
        { id: "2", name: "Warranty Expired", description: "Clients with expired warranties" },
      ]);
      setTags([
  ...
  const Card = ({ item, kind, i }) => (
    <motion.div
      ...
      className="group bg-white/90 border p-5 rounded-2xl shadow hover:shadow-xl transition relative"
    >
  ...
  return (
    <div className="p-8 space-y-10">
      ...
      >
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            className="px-4 py-2 flex items-center gap-2 rounded-xl bg-gradient-to-r from-indigo-600 to-purple-600 text-white shadow hover:scale-105 transition"
          >
      ...
      {/* Audiences */}
      <section>
        <h2 className="text-xl font-bold text-slate-800 mb-4">🎯 Audiences</h2>
      ...
      {/* Tags */}
      <section>
        <h2 className="text-xl font-bold text-slate-800 mb-4">🏷️ Tags</h2>
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
